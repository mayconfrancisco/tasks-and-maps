...
Criar arquivo de src/routes.js, criar as paginas e as navegações para testar o App

Configurando a parte de testes para TDD ;) Acesso o arquivo [readmeinfotests.md](readmeinfotests.md)
